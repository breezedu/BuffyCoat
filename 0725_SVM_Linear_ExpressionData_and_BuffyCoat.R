...
count.bc <- read.table("Counts.Data.txt", row.names = 1, header = T, sep = "\t")
design.bc <- read.table("Counts.Data_Design.txt", row.names = 1, header = T, sep = "\t")
top.genes.bc <- readLines("Deseq2_top47row.txt")
