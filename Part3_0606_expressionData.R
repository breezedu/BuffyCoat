...
setwd("C:/Users/jeffd/OneDrive - QIAGEN GmbH/SVM_RFE_Prj/0604")
...
trainRowNumbers <- createDataPartition(my_data$class, p=0.85, list=FALSE)
testRowNumbers <- createDataPartition(my_data$class, p=0.70, list=FALSE)
...
featurePlot(x = trainData[, 1:16], 
            y = trainData$class, 
            main = "Feature BoxPlot 1-16",
            plot = "box",
...
featurePlot(x = trainData[, 17:32], 
            y = trainData$class, 
            main = "Feature BoxPlot 17-32",
            plot = "box",
            strip=strip.custom(par.strip.text=list(cex=.7)),
            scales = list(x = list(relation="free"), 
                          y = list(relation="free"))
...
featurePlot(x = trainData[, 33:47], 
            y = trainData$class, 
            main = "Feature BoxPlot 33-47",
            plot = "box",
            strip=strip.custom(par.strip.text=list(cex=.7)),
            scales = list(x = list(relation="free"), 
                          y = list(relation="free"))
...
featurePlot(x = trainData[, 1:16], 
            y = trainData$class, 
            main = "Feature Density Plot 1-16",
            plot = "density",
            strip=strip.custom(par.strip.text=list(cex=.7)),
            scales = list(x = list(relation="free"), 
                          y = list(relation="free")))
...
featurePlot(x = trainData[, 17:32], 
            y = trainData$class, 
            main = "Feature Density Plot 17-32",
            plot = "density",
            strip=strip.custom(par.strip.text=list(cex=.7)),
            scales = list(x = list(relation="free"), 
                          y = list(relation="free")))
...
featurePlot(x = trainData[, 33:47], 
            y = trainData$class, 
            main = "Feature Density Plot 33-47",
            plot = "density",
            strip=strip.custom(par.strip.text=list(cex=.7)),
            scales = list(x = list(relation="free"), 
                          y = list(relation="free")))
