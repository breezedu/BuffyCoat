...
#set.seed(100)
#trainRowNumbers <- createDataPartition(my_data$class, p=0.78, list=FALSE)
...
tiff("Plot_svmLinear_Combined_ClinicalBlood.tif", width = 8, height = 8, units = 'in', res = 300)


rocobj_svmlinear <- roc(model_svmLinear$pred$obs, model_svmLinear$pred$yes, ci=TRUE,
                        plot=TRUE, 
                        legacy.axes=TRUE, percent=TRUE,
                        main="Combined Clinical Blood Model svmLinear",
                        xlab="False Positive Percentage", 
                        ylab="True Postive Percentage", 
                        col="darkblue", lwd=5, 
                        print.auc=TRUE,
