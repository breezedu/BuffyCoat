...
setwd("C:/Users/dug/OneDrive - QIAGEN GmbH/SVM_RFE_Prj/Elain_final_reports/")
...
smooth( rocobj_svmlinear, method = "density" ) 
plot( smooth( rocobj_svmlinear.vliad, method = "density" ) )
